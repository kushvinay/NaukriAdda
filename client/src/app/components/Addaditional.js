      ...
      <div className=" bg-white relative w-[40%]  m-auto mt-16 px-14">
        ...
        <form className="flex flex-col items-center justify-center" action="" method="Post" onSubmit={hendelSubmit}>
          ...
          <label className="flex flex-col text-xl" >
            <span className="text-sm text-gray-500 my-2">Add your accomplishments details such as rewards, test scores, certifications etc and you may also add information such as seminars/workshops you have attended or any interests/hobbies you have pursued.</span>
          </label>
